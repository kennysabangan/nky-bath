...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    await resend.emails.send({
      from: `NKY Bathroom Refinishing Pros <lead@scalesolving.com>`,
      to: ['hello@scalesolving.com'],
      subject: `New Lead: ${fullName}` + (page_path && page_path !== '/' ? ` — ${page_path}` : ''),
      html: `<h2>New Lead from NKY Bathroom Refinishing Pros</h2>
...
<p>We received your quote request for <strong>NKY Bathroom Refinishing Pros</strong> and will get back to you shortly.</p>
<p>If you need immediate assistance, call us at <strong>(859) 900-8065</strong>.</p>
<p>— The NKY Bathroom Refinishing Pros Team</p>`,
    });
  } catch (error: any) {
